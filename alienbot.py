...
negative_responses = ("no", "nope", "nah", "naw", "not a chance", "sorry", "nyet", "not even if Soviet Union falls apart")
...
random_questions = (
    ...
    "What technology do you have on this planet? ",
  	"Can I meet Leo Tolstoy? ",
  	"Are Russian women really the most beautiful species on this planet?"
    )
...
# Define greet() below:
def greet():
  name = input("Ahoy, what is your name? ")
